...
bool firstTurn; // 0 = no turns before this one 1 = turn before this one BAD
int orientation; //2 = right turn 1 = left turn
  ...
  while(1) {
    ...
    switch(state){
        ...
        //QTI sensor left is reading the line
          ...
          if (firstTurn) {
            ...
            if (orientation = 1){
              ...
              Serial.println("Uh Oh you shouldn't be here");
              state = END;
            }
          }
      ...
      case FIRSTTURN:
        ...
        if (currentColor == 2){ //after the left turn
          turn_right(260);
          orientation = 2;
        } else {
          orientation = 1;
